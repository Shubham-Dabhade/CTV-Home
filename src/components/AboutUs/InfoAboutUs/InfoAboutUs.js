      ...
      <div className="InsideInfoAboutUs">
        <div className="infoaboutus_left">
          ...
          <div className="infoaboutus_seg3 mar">
            With our extensive and partner networks, we ensure comprehensive
            coverage and dependable connectivity in challenging areas and mature
            markets. As technoloy-driven pioneers, we offer Carrier Grade
            Network Solutions, including Ethernet, MPLS, DIA, SDN/SD-WAN, and
            Cloud-Based services.
          </div>
          <div
            className={`infoaboutus_seg4 mar ${toggleRead ? " " : "common"}`}
          >
            We understand that reliable, high-speed fiber connectivity is vital
            for businesses to thrive in today's digital landscape. Our experts
            work closely with you to implement tailored last mile fiber
            solutions that meet your needs and budget. We provide robust
            connectivity for seamless communication, fast data transfer, and
            improved operational efficiency. Backed by local expertise, we offer
            total management capabilites and a deep understanding of the African
            market.
          </div>
          <div
            className={`infoaboutus_seg5 mar ${toggleRead ? " " : "common"}`}
          >
            Our mission is to provide value for money, create a secure and
            connected future that drives growth, enhances lives, and contributes
            to Tanzania's digital ecosystem.
          </div>
          <div
            className={`infoaboutus_seg6 mar ${toggleRead ? " " : "common"}`}
          >
            ...
            Together, let's build a connecte future for Africa.
          </div>
...
<div className="upper_segment_1_info">
  <img
    className="upper_segment_1_info_img"
    src={require("../../../assets/image-01.png")}
    alt=""
  />
</div>
<div className="bottom_segment_2_info">
  <div className="item-info-block-about-us radialBackGround">
    Tailor made Network Solution for clients
    <img
      src={require("../../../assets/top c .png")}
      alt=""
      className="item-info-block-c top-c-aboutus-info"
    />
  </div>
  <div className="item-info-block-about-us radialBackGround">
